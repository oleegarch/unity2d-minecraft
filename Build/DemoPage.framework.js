...
var ASM_CONSTS = {
  5829560: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 5829615: ($0) => { performance.now = function() { return $0; }; },  
 5829663: ($0) => { performance.now = function() { return $0; }; },  
 5829711: () => { performance.now = Module['emscripten_get_now_backup']; }
};
