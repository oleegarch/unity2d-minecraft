...
var ASM_CONSTS = {
  5826952: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 5827007: ($0) => { performance.now = function() { return $0; }; },  
 5827055: ($0) => { performance.now = function() { return $0; }; },  
 5827103: () => { performance.now = Module['emscripten_get_now_backup']; }
};
