...
var ASM_CONSTS = {
  5828168: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 5828223: ($0) => { performance.now = function() { return $0; }; },  
 5828271: ($0) => { performance.now = function() { return $0; }; },  
 5828319: () => { performance.now = Module['emscripten_get_now_backup']; }
};
