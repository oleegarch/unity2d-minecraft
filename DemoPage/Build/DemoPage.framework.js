...
var ASM_CONSTS = {
  5827816: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 5827871: ($0) => { performance.now = function() { return $0; }; },  
 5827919: ($0) => { performance.now = function() { return $0; }; },  
 5827967: () => { performance.now = Module['emscripten_get_now_backup']; }
};
