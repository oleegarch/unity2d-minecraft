...
var ASM_CONSTS = {
  5827784: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 5827839: ($0) => { performance.now = function() { return $0; }; },  
 5827887: ($0) => { performance.now = function() { return $0; }; },  
 5827935: () => { performance.now = Module['emscripten_get_now_backup']; }
};
