...
namespace World.Chunks
{
    public class ChunksBlockEvents
    {
        ...
        public void InvokeBlockSet(WorldPosition position, Block block, BlockLayer layer, BlockUpdateSource source)
        {
        ...
        public void InvokeBlockBroken(WorldPosition position, Block block, BlockLayer layer, BlockUpdateSource source)
        {
            if (source == BlockUpdateSource.Player)
